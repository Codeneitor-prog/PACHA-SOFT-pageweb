    ...
    <section className="container mx-auto px-6 max-w-5xl">
      ...
      >
        ...
        <div className="relative z-10">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-6 tracking-tighter text-white">
            {title} <span className="text-transparent bg-clip-text bg-linear-to-r from-electric-2 to-electric-4">{highlight}</span>
          </h2>
          <p className="text-gray-400 text-sm md:text-lg mb-10 max-w-2xl mx-auto font-light">
            {description}
          </p>
